...
'Simulation 1'
sim1 = follow_pipeline_simple(1.98,25,@LContainer_uuv,9,4,5,6,10000,0.1,[3 6]);
...
'Simulation 2'
sim2 = follow_pipeline_sonar(1.98,25,@LContainer_uuv,9,4,5,6,10000,0.1,[3 6]);
'Press any key for moving into next simulation'
...
'Simulation 3'
sim3 = follow_pipeline_simple_NN(1.98,25,@LContainer_uuv,9,4,5,6,10000,0.1,[3 6],'controller_mariner_3in_net.mat');
'Press any key for moving into next simulation'
...
'Simulation 4'
sim4 = follow_pipeline_sonar_NN(1.98,25,@LContainer_uuv,9,4,5,6,10000,0.1,[3 6],'controller_mariner_3in_net.mat');
