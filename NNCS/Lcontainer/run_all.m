...
'Simulation 1'
sim1 = follow_pipeline_simple(175,25,@LContainer,9,4,5,6,10000,0.1,[3 6]);
...
figure;
'Simulation 2'
sim2 = follow_pipeline_sonar(175,25,@LContainer,9,4,5,6,10000,0.1,[3 6]);
'Press any key for moving into next simulation'
pause;
clc;
...
figure;
'Simulation 3'
sim3 = follow_pipeline_simple_NN(175,25,@LContainer,9,4,5,6,10000,0.1,[3 6],'controller_mariner_3in_net.mat');
'Press any key for moving into next simulation'
pause;
clc;
...
figure;
'Simulation 4'
sim4 = follow_pipeline_sonar_NN(175,25,@LContainer,9,4,5,6,10000,0.1,[3 6],'controller_mariner_3in_net.mat');
'End of simulations'